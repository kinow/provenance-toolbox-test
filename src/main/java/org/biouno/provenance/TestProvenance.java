...
public class TestProvenance {
	...
	public static final String PC1_NS = "http://biouno.org";
	public static final String PC1_PREFIX = "bu";
	public static final String PRIM_NS = "http://biouno.org/primitives#";
	...
	public static Entity newFile(ProvFactory factory, String id, String label,
		...
		factory.addType(a,
				URI.create("http://biouno.org/primitives#File"));
	...
	public static void main(String[] args) throws Exception {
		...
		WasAttributedTo wasAttributedTo = new org.openprovenance.prov.xml.WasAttributedTo();
		wasAttributedTo.setAgent(agent.getId());
		wasAttributedTo.setEntity(inputFile.getId());
		wasAttributedTo.setId(q(factory, "job triggered by"));
		
		stsBundles.add(step1);
		stsBundles.add(agent);
		stsBundles.add(inputFile);
		
		stsBundles.add(wasAttributedTo);
